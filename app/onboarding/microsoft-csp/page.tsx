    ...
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="h3" component="h1" fontWeight="bold" gutterBottom>
          Alta en Microsoft Cloud Solution Provider (CSP)
        </Typography>
        <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
          Guía completa para el proceso de alta en Microsoft CSP a través de TD SYNNEX
        </Typography>
      </Box>
      ...
      <Card sx={{ p: 4, textAlign: 'center' }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Estamos trabajando en la guía de onboarding para Microsoft Cloud Solution Provider.
      ...
      <Callout type="info" title="Próximamente" sx={{ mt: 4 }}>
        La guía de alta en Microsoft CSP estará disponible pronto. Mientras tanto,
